...
prefixes = ["Sample Inputs:", "Sample Outputs:", "Int Literals:", "String Literals:", "Defined Syntax:"]
for line in lines:
    line = line.strip()  
...
def expand(possible_fns):
    ...
    for i in range(fn_index, possible_fns_length):
...
def synthesize(): 
    ...
    if all(fn not in string_grammar for fn in defined_grammar):
